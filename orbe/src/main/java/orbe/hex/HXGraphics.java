...
public class HXGraphics {
	...
	/**
	 * Largeur d'un hexagone (utilis� pour le calcul de l'�paisseur des lignes)
	 */
	 ...
	 * 
	 * @param hx
	 *            Point exprim� dans le référentiel HX.
	 * @return Point exprim� dans le référentiel PX.
	 */
	...
	/**
	 * Coordonn�es PX d'un coin d'hex.
	 */
	...
	public HXCorner locateCorner(PointDecimal px) {
		...
		// Angle en degr�s (y d'abord, x ensuite, voir la doc)
