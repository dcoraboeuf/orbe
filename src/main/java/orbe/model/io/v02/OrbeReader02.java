...
public class OrbeReader02 extends AbstractOrbeReader<DefaultOrbeMap> implements StyleLine02Constants {
	...
	private OrbeLine parseLine(DefaultOrbeMap map, Element eLigne) {
		...
		// Détermination de la forme de la ligne
		LineForm form;
	...
	/**
	 * Chaque point est exprimé en coordonnées PX. Il faut retrouver le centre
	 * d'hex correspondant.
	 */
	...
	/**
	 * Chaque point est exprimé en coordonnées PX. Il faut retrouver le coin
	 * d'hex correspondant.
	 */
	...
	/**
	 * Chaque point est exprimé en coordonnées PX. Il faut les transformer en
	 * coordonnées PX.
	 */
	...
	private OrbeText parseText(DefaultOrbeMap map, Element eTexte) {
		...
		// Prise en compte du décalage 0.2
		px = shift02(map, px);
		// HX
		HXPoint2D hx = ScaleMath.scalePXToHX(map, px);
		text.setPosition(hx);
	...
	/**
	 * Prise en compte du décalage vertical en 0.2. Le rapport <code>r</code>
	 * est calculé comme suit:
	 * <p>
	 * <code>r = HauteurHex02 / HauteurHex20
	 * </p>
	 * <code>HauteurHex02</code> vaut 23, c'est l'arrondi entier de la hauteur exacte de l'hex. <code>HauteurHex20</code> est la hauteur réelle de l'hex.
	 */
