...
public abstract class RepositoryStyle<S extends Style> {
	 ...
	 * @param id
	 *            ID du style
	 * @return Style correspondant ou <code>null</code> si non trouv�.
	 */
	...
	/**
	 * Liste de tous les styles, tri�s par nom.
	 */
	 ...
	 * 
	 * @return Liste dupliqu�e, ses éléments sont �galement de nouvelles
	 *         instances.
	 */
