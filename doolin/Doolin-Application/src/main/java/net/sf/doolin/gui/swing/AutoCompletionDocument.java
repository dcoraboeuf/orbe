 ...
 * 
 * This class has been created using the wondeful code available at <a
 * href="http://www.orbital-computer.de/JComboBox/">http://www.orbital-computer.de/JComboBox/</a>
 */
public class AutoCompletionDocument extends PlainDocument {
	...
	/**
	 * Constructor for a combo box and a given completion handler.
	 * 
	 * @param comboBox
	 *            Combo box to adapt
	 * @param handler
	 ...
	 */
	public AutoCompletionDocument(final JComboBox comboBox, CompletionHandler handler) {
		if (handler == null) {
			completionHandler = new DefaultCompletionHandler();
		} else {
		...
		editorKeyListener = new KeyAdapter() {
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_BACK_SPACE:
					if (completionHandler.isCompletionAllowsCreation()) {
						// TODO Backspace for creation
					} else {
						hitBackspace = true;
	...
	/**
	 * Enables a combo box for auto completion
	 * 
	 * @param comboBox
	 *            Combo box to enable
	 * @param handler
	 *            Associated completion handler
	 */
	public static void enable(JComboBox comboBox, CompletionHandler handler) {
		// has to be editable
		comboBox.setEditable(true);
		// change the editor's document
		new AutoCompletionDocument(comboBox, handler);
	}
	...
	public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
		...
		if (item != null) {
			...
			if (completionHandler.isCompletionAllowsCreation()) {
				// Creates a new item from the current text
				item = completionHandler.createItem(text);
				setSelectedItem(item);
			} else {
	...
	private static void createAndShowGUI() {
		...
		enable(comboBox, new CompletionHandler() {
