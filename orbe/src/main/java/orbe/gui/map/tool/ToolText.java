...
public class ToolText extends AbstractToolMap {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (text == null) {
			...
			if (editedText != null) {
				...
				// Si la validation n'a d�tect� aucun changement, on passe
				// aussit�t en mode création
	...
	protected void edit(OrbeText text) {
		...
		// Ajustement de la taille en fonction du nombre de caract�res
	...
	protected ValidationResult editValidate() {
		if (editedText != null && editionField != null) {
			...
			// Contr�le du texte
			/*
			 * Si le texte n'a pas chang�, aucune �dition n'est n�cessaire
			 */
			String oldValue = editedText.getValue();
	...
	/**
	 * création d'un menu contextuel pour un texte donn�.
	 * 
	 * @param text
	 *            Texte concern�.
	 * @return Menu � afficher.
	 */
