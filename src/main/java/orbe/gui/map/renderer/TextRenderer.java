...
public class TextRenderer {
	...
	/**
	 * Boite du texte, calculée sans rotation
	 * 
	 * @param text
	 *            Texte de référence.
	 * @param map
	...
	/**
	 * Calcul de la transformation à appliquer dans le référentiel pour les
	...
	/**
	 * Calcul de la transformation à appliquer à l'écran pour les objets
	 * relatifs au texte.
	 * 
	 * @param text
	 *            Texte de référence.
	...
	/**
	 * Configure la taille d'un composant pour l'édition
	 * 
	 * @param field
	 *            Composant à configurer
	 * @param editedText
	 *            Texte édité
	 * @param map
	 *            Carte
	...
	public static void setPosition(JTextField field, OrbeText editedText, OrbeMap map, ViewSettings viewSettings, Graphics2D g) {
		...
		// Ajout de la largeur d'un caractère
